...
class LeKiwiConfig(RobotConfig):
    ...
    # Feetech bus protocol version used by the servo bus.
    # The physical protocol of a Feetech servo is fixed by its hardware/firmware (e.g. STS3215 servos
    # typically run Protocol 1 with a 2-byte header). Set to `0` if your servos answer Protocol 0
    # (4-byte header) pings instead.
